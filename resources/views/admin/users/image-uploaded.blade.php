...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"> Image Uploaded</li>
</ol>
<!--Department Table Card-->
<div class="card mb-3">
    <div class="card-header">
        <i class="fa fa-table"></i> Image Uploaded Table
    ...
    <div class="card-body">
        <div class="float-right">
            <div class="btn-group">
            <a href="/admin/users/image-uploaded" class="btn btn-secondary btn-sm"><i class="fa fa-image"></i> Image Uploaded</a>
...
<script>
    $(document).ready(function() {
        var oTable  =   $('.dataTable').DataTable({
            ...
            paging:         true,
            ajax: {
                url: '{!! route('datatables.users.image-uploaded') !!}',
                data: function (d) {
