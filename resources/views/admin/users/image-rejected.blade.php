...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"> Image Rejected</li>
</ol>
<!--Department Table Card-->
<div class="card mb-3">
    <div class="card-header">
        <i class="fa fa-table"></i> Image Rejected Table
    ...
    <div class="card-body">
        <div class="float-right">
            <div class="btn-group">
                ...
                <a href="/admin/users/image-rejected" class="btn btn-secondary btn-sm"><i class="fa fa-thumbs-down"></i> Image Reject</a>
            </div>
        </div>
        <div class="clearfix"></div>
        <hr>
        ...
        <div class="pt-1 pb-4">
            <button data-toggle="modal" data-target="#massRejectionReminderModal" class="btn btn-danger btn-sm ml-3 " ><i class="fa fa-bell"></i> @lang('Mass Reminder') </button>
        </div>
...
@include('admin.users.partials.mass_rejection_reminder')
...
<script>
    $(document).ready(function() {
        var oTable  =   $('.dataTable').DataTable({
            ...
            paging:         true,
            ajax: {
                url: '{!! route('datatables.users.image-rejected') !!}',
                data: function (d) {
            ...
            columns: [
                ...
                { data: 'reject_reason_id', name: 'reject_reason_id' },
                { data: 'image_rejection_reason', name: 'image_rejection_reason' },
